...
mod test {
    ...
    fn list_parsing() {
        ...
        assert_eq!(
            ItemList(vec![ItemList(vec![Value(1), Value(2)])]),
            parse_list("[1,2]")
        );
        assert_eq!(
            ItemList(vec![ItemList(vec![
                Value(1),
                ItemList(vec![Value(1), Value(2)])
            ])]),
            parse_list("[1,[1,2]]")
        );
        assert_eq!(
            ItemList(vec![ItemList(vec![
                ...
                ItemList(vec![
                    ...
                    ItemList(vec![
                        ...
                        ItemList(vec![
                            Value(4),
                            ItemList(vec![Value(5), Value(6), Value(0),]),
                        ]),
                    ]),
                ]),
                Value(8),
